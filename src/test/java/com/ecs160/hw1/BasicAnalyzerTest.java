...
public class BasicAnalyzerTest {
    ...
    public void testStorePost(){
        ...
        String newPostId = postId.split(":")[1];

        Map<String, String> post = redisDb.getPost(newPostId);
    ...
    public void testStoreReply(){
        String postId = redisDb.storePost("TestUser2", "2025-1-1 1:00:00", "Test post content", 0);
        String replyId = redisDb.storeReply(postId, "User2","This is a reply", "2025-1-1 1:00:00");
        String newReplyId = postId.split(":")[1];

        Map<String, String> reply = redisDb.getReply(newReplyId);
        assertNotNull(reply);
    ...
    public void testReplyCount() {
        String postId = redisDb.storePost("TestUser3", "2025-1-1 1:00:00", "Test post content", 0);
        ...
        String replyCount = redisDb.getReplyCount(newPostId);
